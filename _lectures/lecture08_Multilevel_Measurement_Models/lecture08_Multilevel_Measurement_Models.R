...
if (runStan){
  # compile stan model
  model2LE_Stan =  cmdstan_model(stan_file = "lecture08_model01.stan")
  ...
  save(model2LE_Summary, model2LE_Draws, model2LE_Loo, ppmc2LE, file = "lecture08_model01.RData")

} else {
  load("lecture08_model01.RData")
}
...
if (runStan){
  ...
  # compile stan model
  model2LWP_Stan =  cmdstan_model(stan_file = "lecture08_model02.stan")
  ...
  save(model2LWP_Summary, model2LWP_Draws, model2LWP_Loo, ppmc2LWP, file = "lecture08_model02.RData")

} else {
  load("lecture08_model02.RData")
}
...
if (runStan){
  ...
  # compile stan model
  model2LWPD_Stan =  cmdstan_model(stan_file = "lecture08_model03.stan")
  ...
  save(model2LWPD_Summary, model2LWPD_Draws, model2LWPD_Loo, ppmc2LWPD, file = "lecture08_model03.RData")
} else {
  load("lecture08_model03.RData")
}
...
# compare results with 2PL model theta estimates -- need to reestimate the 2PL model
# estimate 2PL
if (runStan){
  
  model2PL_Stan = cmdstan_model(stan_file = "lecture05_model02.stan")
...
if (runStan){
  ...
  # compile stan model
  model2LWPDV_Stan =  cmdstan_model(stan_file = "lecture08_model04.stan")
  ...
  save(model2LWPDV_Summary, model2LWPDV_Draws, model2LWPDV_Loo, ppmc2LWPDV, file = "lecture08_model04.RData")
} else {
  load("lecture08_model04.RData")
}
...
if (runStan){
  # compile stan model
  modelWPBS_Stan = cmdstan_model(stan_file = "lecture08_model05.stan")
  ...
  save(modelWPBS_Summary, modelWPBS_Draws, modelWPBS_Loo, ppmcWPBS, file = "lecture08_model05.RData")
} else {
...
if (runStan){
  ...
  # compile stan model
  modelMLMMED_Stan = cmdstan_model(stan_file = "lecture08_model06.stan")
  ...
  save(modelMLMMED_Summary, modelMLMMED_Draws, modelMLMMED_Loo, ppmcMLMMED, file = "lecture08_model06.RData")

} else {
  load("lecture08_model06.RData")
}
...
if (runStan){
  ...
  modelMLMMEDnoRI_Stan = cmdstan_model(stan_file = "lecture08_model07.stan")
  ...
  save(
    ...
    modelMLMMEDnoRI_Loo, 
    ppmcMLMMEDnoRI, 
    file = "lecture08_model07.RData"
  )

} else {
  load("lecture08_model07.RData")
}
...
if (runStan){
  ...
  modelMLMMEDlunch_Stan =  cmdstan_model(stan_file = "lecture08_model08.1.stan") 
  ...
  save(
    ...
    file = "lecture08_model08.RData"
  )

} else {
  load("lecture08_model08.RData")
}
...
if (runStan){
  ...
  modelMLMMED2lunch_Stan =  cmdstan_model(stan_file = "lecture08_model09.stan") 
...
modelMLMMED2lunch_Diag = modelMLMMED2lunch_Samples$sampler_diagnostics()
  ...
  save(
    ...
    file = "lecture08_model09.RData"
  )

} else {
  load("lecture08_model09.RData")
}
