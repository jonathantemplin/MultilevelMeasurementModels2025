...
# compile stan model --------------------------------------------------------------------------------------------------
if (runStan){
  model1PL_Stan = cmdstan_model(stan_file = "lecture05_model01.stan")
  ...
  save(model1PL_Summary, model1PL_Draws, model1PL_Loo, ppmc1PL,
       model1PL_Waic, file = "lecture05_model01.RData")

} else {
  load("lecture05_model01.RData")
}
...
if (runStan){
  ...
  save(model2PL_Summary, model2PL_Draws, model2PL_Loo, ppmc2PL, model2PL_Waic, file = "lecture05_model02.RData")

} else {
  load("lecture05_model02.RData")
}
...
if (runStan){
  ...
  model2PLmarker_Stan = cmdstan_model(stan_file = "lecture05_model03.stan")
  ...
  save(
    ...
    model2PLmarker_Loo, 
    ppmc2PLmarker, 
    file = "lecture05_model03.RData"
  )

} else {
  load("lecture05_model03.RData")
}
