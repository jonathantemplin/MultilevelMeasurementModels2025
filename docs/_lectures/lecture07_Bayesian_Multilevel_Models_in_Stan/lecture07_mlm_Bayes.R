...
if (runStan){
  modelEmptyGLM_Stan = cmdstan_model(stan_file = "lecture07_model01.stan")
  ...
  save(modelEmptyGLM_Summary, modelEmptyGLM_Draws, modelEmptyGLM_Loo, file = "lecture07_model01.RData")

} else {
  load("lecture07_model01.RData")
}
...
if (runStan){
  ...
  modelRandomIntercept_Stan = cmdstan_model(stan_file = "lecture07_model02.stan")
  ...
  save(modelRandomIntercept_Summary, modelRandomIntercept_Draws, modelRandomIntercept_Loo, 
       file = "lecture07_model02a.RData")
} else {
  load("lecture07_model02a.RData")
}
...
if (runStan){
  modelEmptyGLMfr_Stan = cmdstan_model(stan_file = "lecture07_model03.stan")
  ...
  save(modelEmptyGLMfr_Summary, modelEmptyGLMfr_Draws, modelEmptyGLMfr_Loo, 
       file = "lecture07_model03.RData")

} else {
  load("lecture07_model03.RData")
}
...
if (runStan){
  ...
  modelEmptyGLMfrRandomIntercept_Stan = cmdstan_model(stan_file = "lecture07_model04.stan")
  ...
  save(modelEmptyGLMfrRandomIntercept_Summary, modelEmptyGLMfrRandomIntercept_Draws, 
       modelEmptyGLMfrRandomIntercept_Loo, file = "lecture07_model04.RData")

} else {
  load("lecture07_model04.RData")
}
...
colnames(modelSmushed_modelMatrix)
  ...
  save(modelSmushed_Summary, modelSmushed_Draws, modelSmushed_Loo, file = "lecture07_model02b.RData")

} else {
  load("lecture07_model02b.RData")
}
...
if (runStan){
  ...
  save(modelLunch_Summary, modelLunch_Draws, modelLunch_Loo, file = "lecture07_model02c.RData")

} else {
  load("lecture07_model02c.RData")
}
...
if (runStan){
  ...
  save(modelLunchCMC_Summary, modelLunchCMC_Draws, modelLunchCMC_Loo, file = "lecture07_model02d.RData")

} else {
  load("lecture07_model02d.RData")
}
...
if (runStan){
  ...
  modelRandomSlope_Stan = cmdstan_model(stan_file = "lecture07_model05.stan")
  ...
  save(modelRandomSlope_Summary, modelRandomSlope_Draws, modelRandomSlope_Loo, file = "lecture07_model05a.RData")

} else {
  load("lecture07_model05a.RData")
}
...
# Write model for the means formula
  ...
  save(modelRandomSlopeCLI_Summary, modelRandomSlopeCLI_Draws, modelRandomSlopeCLI_Loo, 
       file = "lecture07_model05b.RData")

} else {
  load("lecture07_model05b.RData")
}
...
if (runStan){
  ...
  modelMultivariate_Stan = cmdstan_model(stan_file = "lecture07_model06.stan")
  ...
  save(modelMultivariate_Summary, modelMultivariate_Draws, modelMultivariate_Loo, file = "lecture07_model06.RData")
  
} else {
  load("lecture07_model06.RData")
}
